...
import hero from "../assets/img/service5.jpg";

export default function CustomTensileRoofing() {
  return (
      ...
      <section className="relative h-[70vh] flex items-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Custom Tensile Roofing
          </h1>
          <p className="max-w-2xl text-lg opacity-90 text-white">
            High-performance tensile roofing systems engineered for long spans,
            architectural impact, and environmental durability.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Our custom tensile roofing systems are designed to cover large
              spans with minimal structural intrusion, delivering lightweight
              yet robust solutions for commercial, public, and industrial spaces.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Each structure is engineered to meet wind load, UV exposure,
              drainage, and fire safety requirements while enhancing the
          ...
          <div className="bg-[#f8fbff] p-10 rounded-3xl">
            ...
            <ul className="space-y-4 text-gray-700">
              <li>• PVC / PTFE / ETFE Fabric Options</li>
              <li>• Large Clear Span Capability</li>
              <li>• High UV & Weather Resistance</li>
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="max-w-3xl mb-20">
      ...
      <p className="mt-6 text-gray-600 leading-relaxed">
        A structured, collaborative workflow ensuring architectural precision,
        structural integrity, and flawless on-site execution.
      </p>
    </div>
        ...
        {[
          {
            ...
            desc: "Understanding architectural intent, site conditions, and functional requirements.",
          },
          {
            step: "02",
            title: "Structural Engineering",
            desc: "Form-finding, load analysis, detailing, and compliance with codes.",
          },
          {
            step: "03",
            title: "Fabrication",
            desc: "Precision fabrication using certified materials and controlled processes.",
          },
          {
            step: "04",
            title: "Installation",
            desc: "On-site execution with safety, accuracy, and quality assurance.",
          },
        ].map((item, idx) => (
          <div
            key={idx}
      ...
      <section className="py-24 bg-gradient-to-r from-[#0077b6] to-[#03045e] text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Discuss Your Roofing Requirement
          </h2>
          <p className="max-w-2xl mx-auto mb-8 opacity-90 text-white">
            Connect with our technical team to evaluate feasibility, materials,
            and structural options for your project.
          </p>
          <Link
            to="/contact"
